  ...
  return (
    ...
    <div>
      ...
      <div style={{ width: "100px" }}>
        <CircularProgressbar
          value={50} // Set the completion percentage to 50%
          text={`${50}%`} // Display the percentage text
          strokeWidth={8} // Set the thickness of the circle
          styles={buildStyles({
            strokeLinecap: "butt", // Options: "butt", "round", "square"
            textSize: "20px", // Size of the percentage text
